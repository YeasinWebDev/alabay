...
const History = () => {
    return (
        <div className='relative'>
            <div className='h-screen lg:h-[80vh] bg-gradient-to-b from-[#FFC700] to-[#FFF280] absolute inset-0 xl:rotate-2 xl:-mt-6 xl:w-[200%] xl:-ml-3'>
            </div>
            ...
            <div className='relative px-6 py-14 flex flex-col lg:flex-row w-full gap-10'>
                ...
                <img src="/assets/historyImg.png" alt="" className='w-[60vw] md:w-[50vw] lg:w-[40vw] xl:w-[40vw] mx-auto' />
                <div>
